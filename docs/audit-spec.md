...
**Checklist**:
- [ ] Tipar `rawAppearances`
- [ ] Eliminar `@ts-ignore`
- [ ] Verificar que `npm run astro check` no arroja errores nuevos
...
**Checklist**:
- [ ] Reemplazar `(p: any)` con tipos concretos
- [ ] Reemplazar `(m as any)` con tipos concretos
- [ ] Verificar `npm run astro check`
...
**Checklist**:
- [ ] Tipar los resultados de las queries
- [ ] Eliminar `@ts-ignore`
- [ ] Verificar funcionamiento de comparación
